package com.example.bus_tracker.notification_setup;
...
public class NotificationService extends FirebaseMessagingService {
    ...
    public void onNewToken(String token) {
        ...
        try {
            new TopicManager(this).subscribeToTopic("notification");
            // new TopicManager(this).unsubscribeToTopic("version1_1");
